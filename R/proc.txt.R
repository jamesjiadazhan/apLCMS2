...
#'
#' @param filename The text file name. If the file is not in the working directory, the path needs to be given.
...
#' @param find.tol.maxd maximum distance between datapoints that are allowed in the procedure to find tolerance.
