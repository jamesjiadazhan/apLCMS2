...
#' @param use.learn whether to use machine learning approach. The default is TRUE.
...
#' @param intensity.weighted Whether to weight the local density by signal intensities in the initial peak detection stage.
#'
#' @details The function first conducts a machine-learning feature detection in the new dataset. And the conducts the regular feature alignment, retention time adjustment and weak signal recovery.
#'
